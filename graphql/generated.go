...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.addUser":
		...
		return e.complexity.Mutation.AddUser(childComplexity, args["user"].(UserInput)), true
...
var parsedSchema = gqlparser.MustLoadSchema(
	&ast.Source{Name: "./schema/schema.gen.graphql", Input: `schema {
  query: Query
  mutation: Mutation
}
...
func (ec *executionContext) field_Mutation_addUser_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["user"]; ok {
		arg0, err = ec.unmarshalNUserInput2githubᚗcomᚋscharteyᚋgqlgenᚑauthᚑstarterᚋgraphqlᚐUserInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_addUser(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		return ec.resolvers.Mutation().AddUser(rctx, args["user"].(UserInput))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) unmarshalInputUserInput(ctx context.Context, obj interface{}) (UserInput, error) {
	...
	for k, v := range asMap {
		...
		case "person":
			var err error
			it.Person, err = ec.unmarshalNPersonInput2ᚖgithubᚗcomᚋscharteyᚋgqlgenᚑauthᚑstarterᚋgraphqlᚐPersonInput(ctx, v)
			if err != nil {
				return it, err
			}
		}
...
func (ec *executionContext) unmarshalNPersonInput2githubᚗcomᚋscharteyᚋgqlgenᚑauthᚑstarterᚋgraphqlᚐPersonInput(ctx context.Context, v interface{}) (PersonInput, error) {
	return ec.unmarshalInputPersonInput(ctx, v)
}

func (ec *executionContext) unmarshalNPersonInput2ᚖgithubᚗcomᚋscharteyᚋgqlgenᚑauthᚑstarterᚋgraphqlᚐPersonInput(ctx context.Context, v interface{}) (*PersonInput, error) {
	if v == nil {
		return nil, nil
	}
	res, err := ec.unmarshalNPersonInput2githubᚗcomᚋscharteyᚋgqlgenᚑauthᚑstarterᚋgraphqlᚐPersonInput(ctx, v)
	return &res, err
}
...
func (ec *executionContext) unmarshalNUserInput2githubᚗcomᚋscharteyᚋgqlgenᚑauthᚑstarterᚋgraphqlᚐUserInput(ctx context.Context, v interface{}) (UserInput, error) {
